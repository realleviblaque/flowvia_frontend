...
export function renderOngoingProject(allOngoing = ongoingProjects) {
  let viewHtml = '';
  allOngoing.forEach((project) => {
    viewHtml += `
      <div class="project-container js-project-container-${project.id}">
        <div class="left">
          <img src="${project.img}">
        </div>
        <div class="rigt">
          <div class="details-top">
            ...
            <div class="details-action">
              <button class="edit-project"><img src="/Icons/bootstrap icon/pencil-square.svg">Continue</button>
              <button class="delete-project" data-delete-id="${project.id}"><img src="/Icons/bootstrap icon/trash.svg">Delete</button>
            </div>
          </div>
          <div class="details-bottom">
            ...
            <div class="details-down">
              ...
              <div class="details-right">
                <span class="prohject-type">${project.projectType}t</span>
              </div>
            </div>
          </div>
        </div>
  ...
  // document.querySelector('.ongoing-project-wrapper').innerHTML = viewHtml;
} 
