...
export function ProfessionalDetails({all}) {
    ...
    <>
      ...
      <main className="teamPageMain">
        ...
        <div className="team-settings-container">
          <TeamSettingsSidebar />
          <div className="professional-details-contents">
            <div className="top">
              <p className="hd-txt">Professional Details</p>
              <p className="txt">Your Team professional identity - shown to recruiters and clients browsing the marketplace..</p>
            </div>
