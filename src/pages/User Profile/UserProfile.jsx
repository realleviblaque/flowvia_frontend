          ...
          <div className="user-profile-top-container">
            ...
            <div className="profle-action-wrap">
              <div className={`profile-img ${user.accountType === 'Team' ? 'team' : ''} ${user.accountType === 'Recruiter' ? 'recruiter' : ''}`}>
                <img className='pic' src={user.profile} />
                {user.details.isOnline && (
            ...
            <div className="profile-details">
              <div className="profile-name-wrap">
                <p className="name">{user.name} {user.details.isVerified && (<i className={`fa-regular fa-check-circle ${user.accountType === 'Team' ? 'team' : ''} ${user.accountType === 'Recruiter' ? 'recruiter' : ''}`}></i>)}</p>
                <div className={`account-badge ${user.accountType === 'Team' ? 'team-badge' : ''} ${user.accountType === 'Recruiter' ? 'recruiter-badge' : ''}`}>
                  {user.accountType}
                </div>
                {user.details.isVerified ? '' : (
              ...
              <div className="profile-more">
                ...
                <div className="more-info">
                  {user.details.website && (
                    <div className="link-wrap">
                      ...
                      <a href={user.details.website} target="_blank">{user.details.website}</a>
                    </div>
                  )}
                  {user.email && (
                ...
                <div className="follow-details-count">
                  <div>
                    <span className="following">{formatCount(user.details.counts.following)}</span>
                    <p>Following</p>
                  </div>
                  <div>
                    <span className="followers">{formatCount(user.details.counts.followers)}</span>
                    <p>Followers</p>
                  </div>
                  <div>
                    <span className="post-total">{formatCount(user.details.counts.posts)}</span>
                    <p>Posts</p>
                  </div>
                  {user.accountType === 'Recruiter' ? (
                    <div>
                      <span className="projects-count">{formatCount(user.details.counts.jobs)}</span>
                      <p>Jobs</p>
                    </div>
                  ) : (
                    <div>
                      <span className="projects-count">{user.details.counts.project}</span>
                      <p>Projects</p>
                    </div>
                  )}
                </div>
                <div className="profile-category">
                  <div className={`first-category ${user.accountType === 'Recruiter' ? 'recruiter' : ''} ${user.accountType === 'Team' ? 'team' : ''}`}>{user.details.title}</div>
                  {user.details.additionalTitle && (
                    <div className="second-category">{user.details.additionalTitle}</div>
                  )}
                  {user.accountType === 'Recruiter' ? (
                    user.details.openToHire && (
                      <div className="third-category">Open to Hire</div>
                    )
                  ) : (
                    <>
                      {user.details.openToWork && (
