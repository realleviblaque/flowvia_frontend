...
export function PortfolioSection({user}) {
  const 
    [all, ] = useState(0),
    [client, ] = useState(0),
    [personal, ] = useState(0),
      ...
      <div className="main-portfolio-wrap">
        <div className="cards">
          <div>
            ...
            <button onClick={() => navigate(`/${userProfile ? 'profile' : `user/${user.profile.username}`}/porfolio`)}>View Portfolio</button>
          </div>
        ...
        <div className="cards">
          <div>
            ...
            <button onClick={() => navigate(`/${userProfile ? 'profile' : `user/${user.profile.username}`}/porfolio?view=client`)}>View Portfolio</button>
          </div>
        ...
        <div className="cards">
          <div>
            ...
            <button onClick={() => navigate(`/${userProfile ? 'profile' : `user/${user.profile.username}`}/porfolio?view=personal`)}>View Portfolio</button>
          </div>
        ...
        <div className="cards">
          <div>
            ...
            <button onClick={() => navigate(`/${userProfile ? 'profile' : `user/${user.profile.username}`}/porfolio?view=ongoing`)}>View Portfolio</button>
          </div>
