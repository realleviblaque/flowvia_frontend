...
import { TeamPosts } from "../../../../data/TeamPage/TeamProfile/posts";
import { TeamProfilePageRightSidebar } from "../../../../components/TeamPage/Profile/TeamProfilePageRightSidebar";
import { TeamProjectSection } from "../../../../components/TeamPage/Profile/Project/ProjectSection";
import { TeamReviewsSection } from "../../../../components/TeamPage/Profile/Review/ReviewSection";
...
export function TeamProfile({all}) {
  ...
  return (
    ...
    <main className="teamPageMain">
      <div className="team-profile-top-container">
        ...
        <div className="profile-details">
          <div className="profile-name-wrap">
            <p className="name">Flowvia Team <i className="fa-regular fa-check-circle"></i></p>
          ...
          <div className="profile-username-category">
            <p className="username">@flowviateam</p>
            <span></span>
            <p>Creative Agency</p>
          </div>
          <div className="profile-more">
            ...
            <div className="more-info">
              ...
              <div className="member-wrap">
                ...
                <p className="member">0-5</p>
              </div>
              <div className="joined-date-info">
                <i className="fa-solid fa-calendar-alt"></i>
                <p className="joined-date">Created <span>January 2025</span></p>
              </div>
            </div>
            <div className="follow-details-count">
              <div>
                <span className="members">5</span>
                <p>Members</p>
              </div>
              <div>
              ...
              <div>
                <span className="team-status">Open</span>
                <p>Status</p>
              </div>
            </div>
            <div className="profile-category">
              <div className="first-category">Creative Agency</div>
              <div className="second-category">Brand + Digital</div>
          ...
          <section className="activity-section">
            <div className="main-post-wrap">
              ...
              <div className="activity-container">
                {TeamPosts.slice().reverse().map((post) => {
                  return (
                  ...
                  <div className="left">
                    <div>
                      ...
                      <span className="right-side">
                        ...
                        <p className="txt">Creative Agency</p>
                      </span>
                    </div>
                    <div>
                    ...
                    <div>
                      <span className="left-side team-size">
                        <i className="fa-regular fa-user"></i>
                      </span>
                      <span className="right-side">
                        <p className="hd-txt">Team Size</p>
                        <p className="txt">0 - 5 Members</p>
                      </span>
                    </div>
                  </div>
                  <div className="right">
                    ...
                    <div>
                      ...
                      <span className="right-side">
                        <p className="hd-txt">Created Since</p>
                    ...
                    <div>
                      <span className="left-side status">
                        <i className="fa-solid fa-circle-dot"></i>
                      </span>
                      <span className="right-side stat">
                        <p className="hd-txt">Status</p>
                        <p className="txt">Open</p>
                      </span>
                    </div>
                  </div>
                </div>
